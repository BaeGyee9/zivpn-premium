...
echo -e "${G}    ╚══════╝╚═╝  ╚═══╝  ╚═╝     ╚═╝  ╚═══╝${Z}"
echo -e "${M}══════════════════════════════════════════════════════════${Z}"
echo -e "${Y}  🌐 ACCESS POINT  : ${C}http://$IP:19432${Z}"
echo -e "${Y}  👤 USERNAME      : ${C}$WEB_USER${Z}"
echo -e "${Y}  🔑 PASSWORD      : ${C}$WEB_PASS${Z}"
echo -e "${M}══════════════════════════════════════════════════════════${Z}"
echo -e "${C}  ⚙️ SERVICES STATUS${Z}"
echo -e "  ${G}✓ Web Panel        ${C}▶ ${Y}systemctl status zivpn-web${Z}"
echo -e "  ${G}✓ Telegram Bot     ${C}▶ ${Y}systemctl status zivpn-bot${Z}"
echo -e "  ${G}✓ Connection Mgr   ${C}▶ ${Y}systemctl status zivpn-connection${Z}"
echo -e "${M}══════════════════════════════════════════════════════════${Z}"
echo -e "${G}           🚀 DEPLOYED BY မောင်သုည [🇲🇲] 🚀${Z}"
echo -e "${M}══════════════════════════════════════════════════════════${Z}"
echo -e "$LINE"
