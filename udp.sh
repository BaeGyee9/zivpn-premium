...
echo -e "${M}║${C}    ╚══════╝╚═╝  ╚═══╝  ╚═╝     ╚═╝  ╚═══╝${M}              ║${Z}"
echo -e "${M}╠══════════════════════════════════════════════════════════╣${Z}"
echo -e "${M}║${Y}  🌐  ACCESS POINT  ${C}➤ ${G}http://$IP:19432${Y}                      ${M}║${Z}"
echo -e "${M}║${Y}  👤  USERNAME      ${C}➤ ${G}$WEB_USER${Y}                                ${M}║${Z}"
echo -e "${M}║${Y}  🔑  PASSWORD      ${C}➤ ${G}$WEB_PASS${Y}                                ${M}║${Z}"
echo -e "${M}╠══════════════════════════════════════════════════════════╣${Z}"
echo -e "${M}║${C}  ⚙️  SERVICES STATUS                                    ${M}║${Z}"
echo -e "${M}║${C}     ┌─────────────────────────────────────────────┐    ${M}║${Z}"
echo -e "${M}║${C}     │ ${G}✓ Web Panel        ${C}▶ ${Y}systemctl status zivpn-web${C}   │    ${M}║${Z}"
echo -e "${M}║${C}     │ ${G}✓ Telegram Bot     ${C}▶ ${Y}systemctl status zivpn-bot${C}   │    ${M}║${Z}"
echo -e "${M}║${C}     │ ${G}✓ Connection Mgr   ${C}▶ ${Y}systemctl status zivpn-connection${C} │    ${M}║${Z}"
echo -e "${M}║${C}     └─────────────────────────────────────────────┘    ${M}║${Z}"
echo -e "${M}╠══════════════════════════════════════════════════════════╣${Z}"
echo -e "${M}║${G}                                                          ║${Z}"
echo -e "${M}║${G}           ░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░      ║${Z}"
echo -e "${M}║${G}           ░░                                       ░░    ║${Z}"
echo -e "${M}║${G}           ░░   🚀  DEPLOYED BY  🚀                 ░░    ║${Z}"
echo -e "${M}║${G}           ░░      မောင်သုည [🇲🇲]                    ░░    ║${Z}"
echo -e "${M}║${G}           ░░                                       ░░    ║${Z}"
echo -e "${M}║${G}           ░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░      ║${Z}"
echo -e "${M}║${G}                                                          ║${Z}"
echo -e "${M}╚══════════════════════════════════════════════════════════╝${Z}"
